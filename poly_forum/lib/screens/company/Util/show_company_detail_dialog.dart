...
class ShowCompanyDetailDialog extends StatefulWidget {
  final int companyId;

  const ShowCompanyDetailDialog(this.companyId, {Key? key}) : super(key: key);

  @override
  State<ShowCompanyDetailDialog> createState() =>
      _ShowCompanyDetailDialogState();
}

class _ShowCompanyDetailDialogState extends State<ShowCompanyDetailDialog> {
