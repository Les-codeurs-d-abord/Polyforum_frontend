...
class _CandidateDetailDialogState extends State<CandidateDetailDialog> {
  ...
  void initState() {
    ...
    BlocProvider.of<CandidateFormCubit>(context)
        .getCandidateDetail(widget.candidateId);
  }
  ...
  buildCandidateDetailDialog(BuildContext context,
      {CandidateDetail? candidateDetail,
                                            ...
                                            Flexible(
                                                ...
                                                child: (candidateDetail
                                                    ...
                                                    ? OutlinedButton(
                                                        ...
                                                        onPressed: () {
                                                          launch(
                                                              "http://localhost:8080/api/res/${candidateDetail?.cv}");
                                                        },
                                                      )
                                                    : const Text(
                                                        "CV indisponible",
                                  ...
                                  Expanded(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        if (candidateDetail?.tags.isNotEmpty ==
                                            true)
                                          Container(
                                            margin:
