...
class Body extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<CandidateListScreenCubit, CandidateListScreenState>(
        listener: (context, state) {
        },
        builder: (context, state) {
          return buildCandidateListScreen(context);
        }
    );
  }

  buildCandidateListScreen(BuildContext context) {
                                                ...
                                                showDialog(
                                                    ...
                                                    builder: (BuildContext context) {
                                                      return BlocProvider(
                                                        ...
                                                        child: const CandidateFormDialog(),
                                                      );
                                                    },
